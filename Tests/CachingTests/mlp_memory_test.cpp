...
int main() {
    try {
        ...
        tracker.enable_console_logging(true);
        ...
        int64_t batch_size = 1024;
            ...
            {
                ScopedAllocName n("MODEL_PARAMS", AllocLifetime::WEIGHT);
                ...
                {
                    ScopedAllocName n2("FORWARD_PASS", AllocLifetime::ACTIVATION);
                    ...
                    {
                        ScopedAllocName n3("GRADIENTS", AllocLifetime::TEMPORARY);
