...
public:
    ...
    std::string name() const override { return "AsinhBackward"; }
    std::vector<Tensor> apply(std::vector<Tensor>&& grads) override;
};
...
public:
    ...
    std::string name() const override { return "AcoshBackward"; }
    std::vector<Tensor> apply(std::vector<Tensor>&& grads) override;
};
...
public:
    ...
    std::string name() const override { return "AtanhBackward"; }
    std::vector<Tensor> apply(std::vector<Tensor>&& grads) override;
};
